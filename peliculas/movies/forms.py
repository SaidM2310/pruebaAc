...
class MovieReviewForm(forms.Form):
    ...
    title.widget.attrs.update({"class": "block w-full rounded-md bg-white px-3" 
                                  ...
                                  "focus:outline focus:outline-2 focus:-outline-offset-2" 
                                  "focus:outline-indigo-600 sm:text-sm/6"})
    rating.widget.attrs.update({"class": "rounded-md bg-black py-1.5 pl-3 pr-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"})